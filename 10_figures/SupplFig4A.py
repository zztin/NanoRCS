...
if __name__ == "__main__":
    ...
    name_prefix = "CNA-enrichment-OVCA"
    ## Gene table:
    ...
    # OUTPUT
    output_path = "/path/to/NanoRCS/output/output_figures/SupplFig4A"
    output_table = "/path/to/NanoRCS/output/processed_output/SupplFig4A"
    ...
    output_path_figures = os.path.join(output_path + f"/{name_prefix}")
