...
if __name__ == "__main__":
    ...
    name_prefix = "CNA-enrichment-GCT"
    ## Gene table:
    ...
    # OUTPUT
    output_path = "/path/to/NanoRCS/output/output_figures/SupplFig4B"
    output_table = "/path/to/NanoRCS/output/processed_output/SupplFig4B"
